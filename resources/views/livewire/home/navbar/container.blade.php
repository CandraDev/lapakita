<!-- MAIN NAV (Sticky) -->
<nav class="bg-sky-100 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] z-40 sticky top-0"
    style="background-image: url('{{ asset('gui/header.png') }}');">
    <section class="w-full p-2 md:h-auto lg:max-w-6xl lg:mx-auto flex items-center gap-2 lg:p-4 justify-between">
