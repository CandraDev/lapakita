...
{{-- <body class="bg-gray-50 min-h-screen">
    <nav class="fixed top-0 right-0 left-0 bg-white h-14 w-full flex items-center">
    ...
    <div class="h-14 bg-white w-full">

    </div>
    <section class="w-full h-34 bg-sky-50 flex">
    ...
    <section class="fixed bottom-0 right-0 left-0 h-14 bg-white flex items-center justify-center z-50">
                        ...
                        <div class="grid grid-cols-2 w-100 m-4 gap-2">
                            <div class="h-10 rounded border border-slate-400 flex items-center hover:bg-gray-100">
                                <div class="flex items-center justify-center w-10">
                                    <svg viewBox="0 0 24 24" class="text-gray-400 h-6.5 w-6.5 inline-block"
                            ...
                            <div class="h-8 rounded flex items-center hover:bg-gray-100 hover:rounded-xl">
                                <div class="flex items-center justify-center w-10">
                                    <svg class="text-gray-400" width="24" height="24" aria-hidden="true"
                                        aria-hidden="true" type="image/svg+xml" viewBox="0 0 24 24"
    ...
    <main class="lg:max-w-4xl lg:mx-auto ">
        ...
        <section class="px-5 py-4 bg-white ">
            <div class="flex justify-between mb-2">
                ...
                <div class="text-sm pt-1">
                    <span class="font-semibold">4</span> dari 4
                </div>
            </div>
            <div class="w-full h-2 bg-gray-200 rounded-full overflow-hidden mb-2">
                <div class="h-full bg-sky-400 rounded-full" style="width: 100%"></div>
            </div>
        </section>
        <div class="w-9/10 mx-auto border-b border-slate-300 bg-white "></div>

        <section class="w-full p-6  bg-white flex items-center justify-center">
            <div class="w-full  bg-green-100 rounded border border-green-400/50 flex flex-col items-center   p-7">
                <img src="{{ asset('gui/undraw_exam-prep_nmly.svg') }}" alt="Ilust" class="w-40 mt-16 mb-10">
                <h3 class="font-semibold mb-2 text-green-900">
                    Akun Seller telah berhasil diverifikasi!
                </h3>
                <p class="text-center text-sm text-gray-500 mb-3">
                    Setelah melalui proses peninjauan, Anda dapat mulai berjualan di Lapakita! Tambahkan produk, kostumisasi promo dan lakukan banyak hal lainnya di Seller Center Lapakita!
                </p>
            </div>
        </section>
