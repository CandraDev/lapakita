...
{{-- <body class="bg-gray-50 min-h-screen">
    ...
    <section class="w-full bg-white h-50 p-5">
        ...
        <div class="flex justify-between grow-0">
            ...
            <label id="ktpUploadBox"
                ...
                <input type="file" id="ktpFile" accept="image/png, image/jpeg, image/jpg" class="hidden">
    ...
    <section class="w-full bg-white h-50 p-5">
        ...
        <div class="flex justify-between grow-0 bg-white pb-4" id="inputNpwp">
            <label id="npwpUploadBox"
                class="h-30 w-30 bg-gray-50 rounded border border-slate-400/30 flex justify-center items-center flex-col cursor-pointer overflow-hidden">
                <input type="file" id="npwpFile" accept="image/png, image/jpeg, image/jpg" class="hidden">
    ...
    <section class="fixed bottom-0 right-0 left-0 h-14 bg-white flex items-center justify-center py-10">
        <button id="submitBtn"
            class="w-9/10 h-10 rounded-xl shadow bg-sky-500 font-semibold text-white ">
            Daftar
        </button>
    </section>
