...
<body>
    ...
    <div class="max-w-6xl mx-auto flex flex-row my-10 gap-6">
        <sidebar class="w-2/10 bg-white p-4 shadow-lg rounded-lg">
            <div class="flex  ">
                <div class="w-9 h-9 rounded-full bg-gray-400 shrink-0">

                </div>
                <div class="flex flex-col justify-center hover:bg-gray-100 hover:rounded-lg w-full ps-2">
                    <span class="align-middle text-sm font-semibold">{{ Auth::user()->name }}</span>
                    <span class="text-xs -mt-1 text-gray-500">{{ Auth::user()->email }}</span>
                </div>
            </div>
            <div class="w-full  rounded-lg mt-4">
                        <div class="h-7 rounded border border-slate-200  flex items-center hover:bg-gray-100 mb-1">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center">
                                    <div class="text-xs font-semibold text-gray-800">Bronze</div>
                                </div>
                            </div>
                        </div>
                        <div class="h-7 rounded border border-slate-200  flex items-center hover:bg-gray-100">
                            <div class="flex items-center justify-center w-7">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center">
                                    <div class="text-xs font-semibold text-gray-800">1 poin</div>
                                </div>
                            </div>
                        </div>
            </div>
        </sidebar>
        <main class="w-7/10 bg-gray-200 p-4">
            @yield('content')
        </main>
    </div>
</body>
